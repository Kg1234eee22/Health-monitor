...
st.title(" Transformer Insulation Digital Twin EE-447 KG")
...
if st.sidebar.button(" Fault (10 ms)") and st.session_state.fault_days <= 0:
    st.session_state.fault_days = 10 / 86400000
